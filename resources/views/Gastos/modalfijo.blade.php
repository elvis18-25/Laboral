    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <button class="btn btn-danger elimini btn-sm" value="{{$concepto->id}}" type="button"><i class="fas fa-trash"></i>&nbsp;Eliminar</button> 
          <button type="button" class="btn btn-info updates btn-sm" value="{{$concepto->id}}" ><i class="fas fa-save">&nbsp;</i> Guardar</button>
        </div>
      </div>
    </div>
