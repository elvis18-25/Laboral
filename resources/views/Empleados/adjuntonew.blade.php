      ...
      <div class="modal-content" >
        ...
        <div class="modal-body">
            ...
            <div class="custom-file col-sm-8">
              ...
              <button type="button" type="button" id="btnuploa" for="actual-btn"  class="btn btn-info btn-sm"><i class="fas fa-folder-open"></i></button>
            </div>
          </div>
