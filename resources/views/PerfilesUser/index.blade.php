        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-4 text-right">
                    <a href="{{route('PerfilesUsuario.create')}}" class="btn btn-sm btn-info redondo"><button type="button" id="createdperfiles" style="display: none;"></button><i class="fas fa-plus" style="top: 6px; position: relative;"></i></a>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="">
                <table class="table tablesorter" id="perfiles-table">
                    ...
                    <thead class=" text-primary">
                        ...
                        <th class="TitlePer"><b>USUARIOS</b></th>
                        <th class="TitlePer"><b>CREADO POR</b></th>
                      </tr>
                    </thead>
                    <tbody>
                    </tbody>
...
'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
  ...
  table=$('#perfiles-table').DataTable({
    ...
    ajax:
    {
      url:"{{ url('datatableperfilesUsuarios') }}",
    },

    columns:[
    {data:'descripcion',name:'descripcion'},
    {data:'created_at',name:'created_at', class:"center"},
    {data:'users',name:'users',searchable:false,class:"center"},
