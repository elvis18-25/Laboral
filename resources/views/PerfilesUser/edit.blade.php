...
<form action="{{Route('PerfilesUsuario.update',$perfiles->id)}}" method="POST" >
    @csrf
    @method('PUT')
<div class="col-md-12">
    <div class="card ">
        <div class="card-header">
            <div class="row">
                <div class="col-8">
                    <h4 class="card-title" style="font-size: 16px !important; font-weight: bold !important;"><b>EDITAR PERFIL DE USUARIOS</b></h4>
                </div>
                <div class="col-4 text-right">
                    <button type="button" id="createdperfilesUser" title="Agregar Usuario al Perfil" data-toggle="modal" data-target="#Edituser" class="btn btn-info btn-sm redondo"><i class="fas fa-users" style="top: 5px; margin-left: -39%;"></i></button>
                    @include('PerfilesUser.modaleditUser')
                </div>
            </div>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">
                                <button class="btn btn-danger btn-sm remfe" type="button" value="{{$user->id}}"><i class="fas fa-minus"></i></button>
                            </td>
                        </tr>
                        @endif
                        @endif
...
<form action="{{route('PerfilesUsuario.destroy',$perfiles->id)}}" id="deleeperfil" method="POST">
    @csrf
    @method('DELETE');
...
if (e.keyCode== 107) {
  $("#createdperfilesUser").trigger("click");
} 
});
