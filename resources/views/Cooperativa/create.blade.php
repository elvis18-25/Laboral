...
<div class="col-md-12">
    ...
    <div class="card " sty>
        <div class="card-header">
            <div class="row">
                <div class="col-8">
                    <h4 class="card-title" style="font-size: 16px !important; font-weight: bold !important;"><b>NUEVA COOPERATIVA</b></h4>
                </div>
...
document.addEventListener ("keydown", function (e) {
    if (e.keyCode==13) {
 var modal=$('#Empleados').hasClass('show');
    if(modal==false){
        $("#subir").trigger("click");
     };
    }
        ...
        $.ajax({
         method: "PUT",
           data: data,
            ...
            $('#coop-table tbody').append(result);
            arreglo[i]=m
            console.log(arreglo);
...
function FormError(){
    Command: toastr["error"]("Debes de elegir una forma de descuento", "Error")
    toastr.options = {
      "closeButton": false,
      "debug": false,
      "newestOnTop": false,
