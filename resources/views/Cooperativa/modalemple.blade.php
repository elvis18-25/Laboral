  ...
  <div class="modal fade" id="Empleados" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content" style=" width: 964px; margin-top: -160px; height: 615px;" >
                ...
                <tbody>
                  @foreach ($empleados as $empleado)
                    ...
                    @if ($empleado->id_empresa==$empresa)
                      <tr onclick="Add('{{url('agregarCoop',[$empleado->id_empleado])}}',{{$empleado->id_empleado}});" action="{{url('agregarCoop',[$empleado->id_empleado])}}" value="{{$empleado->id_empleado}}" >
