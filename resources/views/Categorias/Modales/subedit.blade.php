        ...
        <div class="modal-body">
          <div class="form-row">
            <div class="col-sm-11 text-left">
                <input type="text" name="newcategoria" id="subcatedit" autofocus  oninput="let p=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(p, p);" class="form-control datosInput" placeholder="{{ __('SUBCATEGORIAS') }}">
            </div>
        </div>
        </div>
