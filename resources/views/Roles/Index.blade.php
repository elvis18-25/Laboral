        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-4 text-right">
                    <a href="{{route('Roles.create')}}" title="Agregar Nuevo Rol" class="btn btn-sm btn-info redondo"><button type="button" id="createdroles"  style="display: none;"></button><i class="fas fa-plus" style="top: 6px;
                      position: relative;
                      margin-left: -2px;
                      font-size: 17px;"></i></a>
                </div>
